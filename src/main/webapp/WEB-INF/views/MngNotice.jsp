...
<head>
    ...
    {
    	location.href='http://localhost:8085/hoho130/resveCancle?mbr_email='+EMAIL+'&resve_date='+RESVE_DATE+'&resve_hour='+RESVE_HOUR;
    }
					...
					<tr>
						...
						<td>
							<button type="button" class="btn btn-success"
								onclick="location.href='http://localhost:8085/hoho130/noticeSltOne?mngr_id=${list.mngr_id}&rgsde=${list.rgsde}'">
								상세정보</button>
						</td>
