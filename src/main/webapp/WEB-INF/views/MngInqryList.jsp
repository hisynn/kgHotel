...
<body>
			...
			<table class="table">			
				...
				<c:forEach var="dto" items="${list }">
					<tr>
						...
						<td>${dto.inqry_ty }</td>
						<td style="text-align: left;"><a href="${actionPath }/inqryContents?mbr_email=${dto.mbr_email }&inqry_date=${dto.inqry_date }">${dto.inqry_sj }</a></td>
						<td>${dto.mbr_email }</td>
						<td>
	...
	<script type="text/javascript">
		fn_selectList = function(){
			...
			$("#inqryForm").attr("action", "http://localhost:8085/hoho130/inqryList");
			$("#inqryForm").submit();
		}
