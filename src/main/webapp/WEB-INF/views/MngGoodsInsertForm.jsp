...
<body>
	...
	<script type="text/javascript">
		...
		fn_insertRumty = function(){
			...
			$.ajax({
				url: 	  "http://localhost:8085/hoho130/ajaxInsertRumty",
				type: 	  "post",
				dataType: "json",
				...
				success:  function(){
					alert("등록 되었습니다.");
					window.location.href = "http://localhost:8085/hoho130/goodsList";
				}
			})		
		}
		...
		fn_insertGoods = function(){
			...
			$.ajaxSettings.traditional = true;
			$.ajax({
				url: 	  "http://localhost:8085/hoho130/ajaxInsertGoods",
				type: 	  "post",
				dataType: "json",
		...
		fn_insertOption = function(){
			...
			$.ajaxSettings.traditional = true;
			$.ajax({
				url: 	  "http://localhost:8085/hoho130/ajaxInsertOption",
				type: 	  "post",
				dataType: "json",
