...
<body>
	...
	<div class="row footer">
		<div class="col-sm-12">
			<form action="http://localhost:8085//resveSltMulti">
			<div align="right">
						...
						<td></td>
							...
							<td>
								<button type="button" class="btn btn-success"
									onclick="location.href='http://localhost:8085/hoho130/resveSltOne?mbr_email=${list.mbr_email}&date=${list.resve_date}'">
									상세정보</button>
							</td>
