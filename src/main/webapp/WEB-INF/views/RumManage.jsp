...
<head>
    ...
    function chckt()
    {
    	location.href='http://localhost:8085/hoho130/rumChckt?rum_no='+RUMNO;
    }
    
    function chkin()
    {
        location.href='http://localhost:8085/hoho130/rumChkin?rum_no='+RUMNO;
    }
    function rumcheck()
    {
        location.href='http://localhost:8085/hoho130/rumCheck?rum_no='+RUMNO;
    }
    function rumcheckend()
    {
        location.href='http://localhost:8085/hoho130/rumCheckEnd?rum_no='+RUMNO;
    }
	</script>
</head>
<!-- 배너 -->
