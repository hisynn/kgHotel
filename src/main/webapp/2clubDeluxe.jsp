...
<!-- HEADER 종료 -->
	...
	<div class="row whiteback">
		<div class="container" >
			<div class="row">
				<div class="col-sm-12">
					<h1 class="roomh1">CLUB DELUXE</h1><br>
						<h5 class="roomh5">편안한 휴식과 최고의 만족을 이끌어내는 클럽 딜럭스는 스카이뷰를 자랑하는
														클럽 라운지에서의 조식과 해피아워를 즐길 수 있어<br> 커플 또는 비즈니스 여행객에게 적합한 객실입니다.</h5><br><br>
							<div id="s_banner_wrap">
								<ul class="bxslider">
							      	<li><div><img src="images/room3.jpg" ></div></li>
							      	<li><div><img src="images/rooms/clubDeluxe2.jpg" ></div></li>
							      	<li><div><img src="images/rooms/clubDeluxe3.jpg" ></div></li>
							      	<li><div><img src="images/rooms/clubDeluxe4.jpg" ></div></li>
							      	<li><div><img src="images/rooms/clubDeluxe5.jpg" ></div></li>
							      	<li><div><img src="images/rooms/clubDeluxe6.jpg" ></div></li>
   		 						</ul>
								<div id="bx-pager1">
							      <a data-slide-index="0" href=""><img src="images/room3.jpg" style="width:175px; height:100px;"></a>
							      <a data-slide-index="1" href=""><img src="images/rooms/clubDeluxe2.jpg" style="width:175px; height:100px;"></a>
							      <a data-slide-index="2" href=""><img src="images/rooms/clubDeluxe3.jpg" style="width:175px; height:100px;"></a>
							      <a data-slide-index="3" href=""><img src="images/rooms/clubDeluxe4.jpg" style="width:175px; height:100px;"></a>
							      <a data-slide-index="4" href=""><img src="images/rooms/clubDeluxe5.jpg" style="width:175px; height:100px;"></a>
							      <a data-slide-index="5" href=""><img src="images/rooms/clubDeluxe6.jpg" style="width:175px; height:100px;"></a>
								</div>
							</div>							
						</div>
					</div>
		...
		<div class="row whiteback">
			<div class="container">
				...
				<div class="col-sm-12" style="margin-top:50px;">
					<div class="row">
						<div class="col-sm-6">
							<p class="roomdetail2" >클럽 디럭스 룸은 고객분들께 호텔에서 누릴 수 있는 최상의 서비스를 제공합니다.</p><br>
							<p class="roomdetail4">클럽 디럭스의 해피아워(17:00~19:00)를 통해 음료와 스낵을 무료로 즐길 수 있습니다.</p><br>
							<ul>
