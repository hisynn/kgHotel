...
<!-- HEADER 종료 -->
	...
	<div class="row whiteback">
		<div class="container" >
			<div class="row">
				<div class="col-sm-12">
					<h1 class="roomh1">GRAND SUITE</h1><br>
						<h5 class="roomh5">녹음이 우거진 팔공산을 파노라믹 뷰로 감상할 수 있는 한실 타입과 샴페인 파티를 위한 스페셜 테이블을 갖춘 양실 타입으로<BR> 구분되는
그랜드 스위트는 고객의 취향에 따라 원하는 타입을 고를 수 있는 객실입니다.</h5><br><br>
							<div id="s_banner_wrap">
								<ul class="bxslider">
							      	<li><div><img src="images/room6.jpg" ></div></li>
							      	<li><div><img src="images/rooms/grandSuite1.jpg" ></div></li>
							      	<li><div><img src="images/rooms/grandSuite2.jpg" ></div></li>
							      	<li><div><img src="images/rooms/grandSuite3.jpg" ></div></li>
							      	<li><div><img src="images/rooms/grandSuite4.jpg" ></div></li>
							      	<li><div><img src="images/rooms/grandSuite5.jpg" ></div></li>
   		 						</ul>
								<div id="bx-pager1">
							      <a data-slide-index="0" href=""><img src="images/room6.jpg" style="width:175px; height:100px;"></a>
							      <a data-slide-index="1" href=""><img src="images/rooms/grandSuite1.jpg" style="width:175px; height:100px;"></a>
							      <a data-slide-index="2" href=""><img src="images/rooms/grandSuite2.jpg" style="width:175px; height:100px;"></a>
							      <a data-slide-index="3" href=""><img src="images/rooms/grandSuite3.jpg" style="width:175px; height:100px;"></a>
							      <a data-slide-index="4" href=""><img src="images/rooms/grandSuite4.jpg" style="width:175px; height:100px;"></a>
							      <a data-slide-index="5" href=""><img src="images/rooms/grandSuite5.jpg" style="width:175px; height:100px;"></a>
								</div>
							</div>							
						</div>
					</div>
		...
		<div class="row whiteback">
			<div class="container">
				...
				<div class="col-sm-12" style="margin-top:50px;">
					<div class="row">
						<div class="col-sm-6">
							<p class="roomdetail2" >그랜드 스위트는 고객의 취향에 따라 원하는 타입을 고를 수 있는 객실입니다.</p><br>
							<p class="roomdetail4">녹음이 우거진 팔공산을 파노라믹 뷰로 감상할 수 있는 한실 타입과 샴페인 파티를 위한 스페셜 테이블을 갖춘 양실 타입입니다.</p><br>
							<ul>
