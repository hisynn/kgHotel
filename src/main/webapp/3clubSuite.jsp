...
<!-- HEADER 종료 -->
	...
	<div class="row whiteback">
		<div class="container" >
			<div class="row">
				<div class="col-sm-12">
					<h1 class="roomh1">HOTEL SUITE</h1><br>
						<h5 class="roomh5">고풍스러운 한국 전통 디자인의 CLUB 스위트룸은 집처럼 편안함을 자랑하여 비즈니스, 레저 여행객 모두를 위한 최적의 객실입니다.</h5><br><br>
							<div id="s_banner_wrap">
								<ul class="bxslider">
							      	<li><div><img src="images/room4.jpg" ></div></li>
							      	<li><div><img src="images/rooms/Suite1.jpg" ></div></li>
							      	<li><div><img src="images/rooms/Suite2.jpg" ></div></li>
							      	<li><div><img src="images/rooms/Suite3.jpg" ></div></li>
							      	<li><div><img src="images/rooms/Suite4.jpg" ></div></li>
							      	<li><div><img src="images/rooms/Suite5.jpg" ></div></li>
   		 						</ul>
								<div id="bx-pager1">
							      <a data-slide-index="0" href=""><img src="images/room4.jpg" style="width:175px; height:100px;"></a>
							      <a data-slide-index="1" href=""><img src="images/rooms/Suite1.jpg" style="width:175px; height:100px;"></a>
							      <a data-slide-index="2" href=""><img src="images/rooms/Suite2.jpg" style="width:175px; height:100px;"></a>
							      <a data-slide-index="3" href=""><img src="images/rooms/Suite3.jpg" style="width:175px; height:100px;"></a>
							      <a data-slide-index="4" href=""><img src="images/rooms/Suite4.jpg" style="width:175px; height:100px;"></a>
							      <a data-slide-index="5" href=""><img src="images/rooms/Suite5.jpg" style="width:175px; height:100px;"></a>
								</div>
							</div>							
						</div>
					</div>
		...
		<div class="row whiteback">
			<div class="container">
				...
				<div class="col-sm-12" style="margin-top:50px;">
					<div class="row">
						<div class="col-sm-6">
							<p class="roomdetail2" >클럽 스위트는 넓은 공간과 편안한 인테리어를 갖추고 있으며, 품격 있는 여행을 위한 최고의 서비스를 제공합니다. </p><br>
							<p class="roomdetail4">스카이뷰를 자랑하는 클럽 라운지에서의 조식과 해피아워 입장이 제공되며,사랑하는 아이와의 특별한 가족 여행을 위해 핑크빛 바비룸과 패밀리 캐릭터 룸도 준비되어 있습니다.</p><br>
							<ul>
