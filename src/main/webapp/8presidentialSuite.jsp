...
<!-- HEADER 종료 -->
	...
	<div class="row whiteback">
		<div class="container" >
			<div class="row">
				<div class="col-sm-12">
					<h1 class="roomh1">PRESIDENTIAL SUITE</h1><br>
						<h5 class="roomh5">HOTEL 최고층에 위치한 프레지덴셜 스위트는 배산임수를 주제로<BR>
														푸르른 팔공산과 수려한 금호강 경관을 동시에 감상할 수 있는 국빈급 VIP 전용 객실입니다.</h5><br><br>
							<div id="s_banner_wrap">
								<ul class="bxslider">
							      	<li><div><img src="images/room5.jpg" ></div></li>
							      	<li><div><img src="images/rooms/presidentialSuite1.jpg" ></div></li>
							      	<li><div><img src="images/rooms/presidentialSuite2.jpg" ></div></li>
							      	<li><div><img src="images/rooms/presidentialSuite3.jpg" ></div></li>
							      	<li><div><img src="images/rooms/presidentialSuite4.jpg" ></div></li>
							      	<li><div><img src="images/rooms/presidentialSuite5.jpg" ></div></li>
   		 						</ul>
								<div id="bx-pager1">
							      <a data-slide-index="0" href=""><img src="images/room5.jpg" style="width:175px; height:100px;"></a>
							      <a data-slide-index="1" href=""><img src="images/rooms/presidentialSuite1.jpg" style="width:175px; height:100px;"></a>
							      <a data-slide-index="2" href=""><img src="images/rooms/presidentialSuite2.jpg" style="width:175px; height:100px;"></a>
							      <a data-slide-index="3" href=""><img src="images/rooms/presidentialSuite3.jpg" style="width:175px; height:100px;"></a>
							      <a data-slide-index="4" href=""><img src="images/rooms/presidentialSuite4.jpg" style="width:175px; height:100px;"></a>
							      <a data-slide-index="5" href=""><img src="images/rooms/presidentialSuite5.jpg" style="width:175px; height:100px;"></a>
								</div>
							</div>							
						</div>
					</div>
		...
		<div class="row whiteback">
			<div class="container">
				...
				<div class="col-sm-12" style="margin-top:50px;">
					<div class="row">
						<div class="col-sm-6">
							<p class="roomdetail2" >고급스러운 펜트하우스의 응접실을 콘셉트로 구현한 투숙객 전용 비즈니스 공간입니다.</p><br>
							<p class="roomdetail4">20층 최상층에 위치해 팔공산의 사계절 풍광과 도시의 전경이 그림처럼 펼처지는 라운지에서 하루 네 번 제공되는 특별한 다이닝 경험을 선사합니다.</p><br>
							<ul>
