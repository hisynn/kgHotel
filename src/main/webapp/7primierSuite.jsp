...
<!-- HEADER 종료 -->
	...
	<div class="row whiteback">
		<div class="container" >
			<div class="row">
				<div class="col-sm-12">
					<h1 class="roomh1">PRIMIER SUITE</h1><br>
						<h5 class="roomh5">청명한 하늘과 닿은 한강 풍경을 바라보며 스파를 즐길 수 있는 프리미어 스위트는<BR>
														다양한 기능을 충족시켜주는 넓은 거실과 두 개의 침실로 이루어진 객실입니다.</h5><br><br>
							<div id="s_banner_wrap">
								<ul class="bxslider">
							      	<li><div><img src="images/room8.jpg" ></div></li>
							      	<li><div><img src="images/rooms/primierSuite1.jpg" ></div></li>
							      	<li><div><img src="images/rooms/primierSuite2.jpg" ></div></li>
							      	<li><div><img src="images/rooms/primierSuite3.jpg" ></div></li>
							      	<li><div><img src="images/rooms/primierSuite4.jpg" ></div></li>
							      	<li><div><img src="images/rooms/primierSuite5.jpg" ></div></li>
   		 						</ul>
								<div id="bx-pager1">
							      <a data-slide-index="0" href=""><img src="images/room8.jpg" style="width:175px; height:100px;"></a>
							      <a data-slide-index="1" href=""><img src="images/rooms/primierSuite1.jpg" style="width:175px; height:100px;"></a>
							      <a data-slide-index="2" href=""><img src="images/rooms/primierSuite2.jpg" style="width:175px; height:100px;"></a>
							      <a data-slide-index="3" href=""><img src="images/rooms/primierSuite3.jpg" style="width:175px; height:100px;"></a>
							      <a data-slide-index="4" href=""><img src="images/rooms/primierSuite4.jpg" style="width:175px; height:100px;"></a>
							      <a data-slide-index="5" href=""><img src="images/rooms/primierSuite5.jpg" style="width:175px; height:100px;"></a>
								</div>
							</div>							
						</div>
					</div>
		...
		<div class="row whiteback">
			<div class="container">
				...
				<div class="col-sm-12" style="margin-top:50px;">
					<div class="row">
						<div class="col-sm-6">
							<p class="roomdetail2" >세계적인 수준의 침구류와 서비스로 생에 최고의 휴식을 선사합니다.</p><br>
							<p class="roomdetail4">청명한 하늘과 닿은 한강 풍경을 바라보며 스파를 즐길 수 있는 프리미어 스위트는
																다양한 기능을 충족시켜주는 넓은 거실과 두 개의 침실로 이루어진 객실입니다.</p><br>
							<ul>
