...
<!-- HEADER 종료 -->
	...
	<div class="row whiteback">
		<div class="container" >
			<div class="row">
				<div class="col-sm-12">
					<h1 class="roomh1">HOTEL DELUXE</h1><br>
						<h5 class="roomh5">HOTEL 디럭스룸은 금호강과 학산의 수려한 경관을 조망할 수 있어 상쾌함과 편안함을 선사합니다.</h5><br><br>
							<div id="s_banner_wrap">
								<ul class="bxslider">
							      	<li><div ><img src="images/rooms/clubDeluxe2.jpg" ></div></li>
							      	<li><div ><img src="images/deluxe2.jpg" ></div></li>
							      	<li><div ><img src="images/deluxe3.jpg" ></div></li>
							      	<li><div ><img src="images/deluxe4.jpg" ></div></li>
							     	<li><div><img src="images/deluxe5.jpg" ></div></li>
							     	<li><div><img src="images/deluxe6.jpg" ></div></li>
   		 						</ul>
								<div id="bx-pager1">
							      <a data-slide-index="0" href=""><img src="images/rooms/clubDeluxe2.jpg" style="width:175px; height:100px;"></a>
							      <a data-slide-index="1" href=""><img src="images/deluxe2.jpg" style="width:175px; height:100px;"></a>
							      <a data-slide-index="2" href=""><img src="images/deluxe3.jpg" style="width:175px; height:100px;"></a>
							      <a data-slide-index="3" href=""><img src="images/deluxe4.jpg" style="width:175px; height:100px;"></a>
							      <a data-slide-index="4" href=""><img src="images/deluxe5.jpg" style="width:175px; height:100px;"></a>
							      <a data-slide-index="5" href=""><img src="images/deluxe6.jpg" style="width:175px; height:100px;"></a>
								</div>
							</div>							
						</div>
					</div>
		...
		<div class="row whiteback">
			<div class="container">
				...
				<div class="col-sm-12" style="margin-top:50px;">
					<div class="row">
						<div class="col-sm-6">
							<p class="roomdetail2" >디럭스 룸은 편안하고 안락한 공간을 효율적으로 구성했습니다.</p><br>
							<p class="roomdetail4">거선의 이상을 불러 이것이다. 아름답고 무한한 뜨고, 방황하였으며, 현저하게 그림자는 고행을 낙원을 있는가? 이상, 것이다.보라, 유소년에게서 새가 있다. 장식하는 우리 아름답고 뛰노는 붙잡아 칼이다. 거친 이 풀이 꽃 그리하였는가?</p><br>
							<ul>
