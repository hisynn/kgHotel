...
<!-- HEADER 종료 -->
	...
	<div class="row whiteback">
		<div class="container" >
			<div class="row">
				<div class="col-sm-12">
					<h1 class="roomh1">HOTEL ROYAL</h1><br>
						<h5 class="roomh5">안락한 휴식과 프라이빗한 사교를 즐기기에 최적화된 로열룸은 2개의 침실과 거실과 모던한 스타일로 이루어진 객실입니다.</h5><br><br>
							<div id="s_banner_wrap">
								<ul class="bxslider">
							      	<li><div><img src="images/room9.jpg" ></div></li>
							      	<li><div><img src="images/rooms/royal1.jpg" ></div></li>
							      	<li><div><img src="images/rooms/royal2.jpg" ></div></li>
							      	<li><div><img src="images/rooms/royal3.jpg" ></div></li>
							      	<li><div><img src="images/rooms/royal4.jpg" ></div></li>
							      	<li><div><img src="images/rooms/royal5.jpg" ></div></li>
   		 						</ul>
								<div id="bx-pager1">
							      <a data-slide-index="0" href=""><img src="images/room9.jpg" style="width:175px; height:100px;"></a>
							      <a data-slide-index="1" href=""><img src="images/rooms/royal1.jpg" style="width:175px; height:100px;"></a>
							      <a data-slide-index="2" href=""><img src="images/rooms/royal2.jpg" style="width:175px; height:100px;"></a>
							      <a data-slide-index="3" href=""><img src="images/rooms/royal3.jpg" style="width:175px; height:100px;"></a>
							      <a data-slide-index="4" href=""><img src="images/rooms/royal4.jpg" style="width:175px; height:100px;"></a>
							      <a data-slide-index="5" href=""><img src="images/rooms/royal5.jpg" style="width:175px; height:100px;"></a>
								</div>
							</div>							
						</div>
					</div>
		...
		<div class="row whiteback">
			<div class="container">
				...
				<div class="col-sm-12" style="margin-top:50px;">
					<div class="row">
						<div class="col-sm-6">
							<p class="roomdetail2" >로열룸은 창문을 통해 들어오는 자연 채광이 특히 여유로움을 더하는 공간 입니다.</p><br>
							<p class="roomdetail4">로열룸은 고급스러운 분위기 아래 럭셔리한 라이프 스타일을 반영한 이곳은 품격있는 서비스와 여가를 원하시는 고객 모두가 만족할 수 있습니다.</p><br>
							<ul>
