...
<head>
	<meta charset="UTF-8">
	<title>GRAND SUITE FAMILY</title>
	<!--  CSS -->
...
<!-- HEADER 종료 -->
	...
	<div class="row whiteback">
		<div class="container" >
			<div class="row">
				<div class="col-sm-12">
					<h1 class="roomh1">GRAND FAMILY SUITE</h1><br>
						<h5 class="roomh5">안락한 반원형 형태의 소파를 중심으로 영화를 감상할 수 있는 미디어 룸을 갖춘<BR>
														그랜드 패밀리 스위트는 가족 또는 지인들과 소중한 추억을 보내기 좋은 최적의 객실입니다.</h5><br><br>
							<div id="s_banner_wrap">
								<ul class="bxslider">
							      	<li><div><img src="images/room7.jpg" ></div></li>
							      	<li><div><img src="images/rooms/grandFamily1.jpg" ></div></li>
							      	<li><div><img src="images/rooms/grandFamily2.jpg" ></div></li>
							      	<li><div><img src="images/rooms/grandFamily3.jpg" ></div></li>
							      	<li><div><img src="images/rooms/grandFamily4.jpg" ></div></li>
							      	<li><div><img src="images/rooms/grandFamily5.jpg" ></div></li>
   		 						</ul>
								<div id="bx-pager1">
							      <a data-slide-index="0" href=""><img src="images/room7	.jpg" style="width:175px; height:100px;"></a>
							      <a data-slide-index="1" href=""><img src="images/rooms/grandFamily1.jpg" style="width:175px; height:100px;"></a>
							      <a data-slide-index="2" href=""><img src="images/rooms/grandFamily2.jpg" style="width:175px; height:100px;"></a>
							      <a data-slide-index="3" href=""><img src="images/rooms/grandFamily3.jpg" style="width:175px; height:100px;"></a>
							      <a data-slide-index="4" href=""><img src="images/rooms/grandFamily4.jpg" style="width:175px; height:100px;"></a>
							      <a data-slide-index="5" href=""><img src="images/rooms/grandFamily5.jpg" style="width:175px; height:100px;"></a>
								</div>
							</div>							
						</div>
					</div>
		...
		<div class="row whiteback">
			<div class="container">
				...
				<div class="col-sm-12" style="margin-top:50px;">
					<div class="row">
						<div class="col-sm-6">
							<p class="roomdetail2" >품격있는 스타일과 서비스로 가족 또는 지인과 최고의 추억을 선사합니다.</p><br>
							<p class="roomdetail4">안락한 반원형 형태의 소파를 중심으로 영화를 감상할 수 있는 미디어 룸을 갖춘
그랜드 패밀리 스위트는 가족 또는 지인들과 소중한 추억을 보내기 좋은 최적의 객실입니다.</p><br>
							<ul>
