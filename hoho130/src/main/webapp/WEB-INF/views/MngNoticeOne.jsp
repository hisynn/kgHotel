...
<head>
    ...
    {
    	location.href='http://15.164.14.206:8080/hoho130/noticeCancle';
    }
    function noticeUpdate()
    {
    	location.href='http://15.164.14.206:8080/hoho130/noticeUpdate';
    }
	...
	<div class="row footer">
		...
		<div class="col-sm-4">
			...
			<table class="table">
				...
				onclick="location.href='http://15.164.14.206:8080/hoho130/noticeDelete?mngr_id=${NOTICE.mngr_id}&rgsde=${NOTICE.rgsde}'">
				삭제</button>
				</div>
			</form>
			<div align="right">
