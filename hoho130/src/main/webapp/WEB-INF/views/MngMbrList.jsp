...
<body>
			...
			<div class="col-sm-6">
				...
				<table class="table">
					...
					<c:forEach var="dto" items="${list }">
						<tr>
							<td><a href="http://15.164.14.206:8080/memberUpdateForm?mbr_email=${dto.mbr_email }">${dto.mbr_email }</a></td>
							<td>${dto.mbr_name }</td>
	...
	fn_selectListByInput = function(){
		...
		$("#memberForm").attr("action","http://15.164.14.206:8080/memberList");
		$("#memberForm").submit();
	}
